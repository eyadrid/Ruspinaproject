...
class CategorieServiceImplTest {
    ...
    void testFetchCategorieByName() {
        ...
        when(categorieDTOMapper.apply(Mockito.<Categorie>any())).thenReturn(categorieDTO);
        ResponseEntity<CustomResponseEntity<CategorieDTO>> actualFetchCategorieByNameResult = categorieServiceImpl
                .fetchCategorieByName("Categorie Name");
        assertTrue(actualFetchCategorieByNameResult.hasBody());
        assertTrue(actualFetchCategorieByNameResult.getHeaders().isEmpty());
        assertEquals(200, actualFetchCategorieByNameResult.getStatusCodeValue());
        CustomResponseEntity<CategorieDTO> body = actualFetchCategorieByNameResult.getBody();
        assertTrue(body.isStatusString());
        assertEquals(HttpStatus.OK, body.getStatus());
        assertSame(categorieDTO, body.getData());
    ...
    @Test
    void testFetchCategorieByName2() {
        Categorie categorie = new Categorie();
        categorie.setArticles(new ArrayList<>());
        categorie.setDescription("The characteristics of someone or something");
        categorie.setId(1L);
        ...
        when(categorieDTOMapper.apply(Mockito.<Categorie>any()))
                .thenThrow(new ResourceNotFoundException("An error occurred"));
        assertThrows(ResourceNotFoundException.class, () -> categorieServiceImpl.fetchCategorieByName("Categorie Name"));
        verify(categorieRepository).fetchCategorieByName(Mockito.<String>any());
        verify(categorieDTOMapper).apply(Mockito.<Categorie>any());
    }

    @Test
    void testFetchCategorieByName3() {
    ...
    /**
     * Method under test: {@link CategorieServiceImpl#fetchAllCategories(long)}
     */
    @Test
    void testFetchAllCategories() {
        when(categorieRepository.fetchAllCategories()).thenReturn(new ArrayList<>());
        ResponseEntity<CustomResponseEntity<List<CategorieDTO>>> actualFetchAllCategoriesResult = categorieServiceImpl
        ...
        CustomResponseEntity<List<CategorieDTO>> body = actualFetchAllCategoriesResult.getBody();
        assertTrue(body.isStatusString());
        assertEquals(HttpStatus.OK, body.getStatus());
        assertTrue(body.getData().isEmpty());
        verify(categorieRepository).fetchAllCategories();
    }
    ...
    void testFetchAllCategories2() {
        ...
        when(categorieRepository.fetchAllCategories()).thenReturn(categorieList);
        when(categorieDTOMapper.apply(Mockito.<Categorie>any()))
    ...
    void testFetchAllCategories3() {
        ...
        assertEquals(HttpStatus.OK, body.getStatus());
        assertEquals(1, body.getData().size());
        verify(categorieRepository, atLeast(1)).fetchAllCategories();
        verify(categorieDTOMapper).apply(Mockito.<Categorie>any());
    }
