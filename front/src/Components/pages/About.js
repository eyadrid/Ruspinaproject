    ...
    <div className='about'>
      <div className='AboutTop' style={{backgroundImage: `url(${image})`}}></div>
        <div className='AboutBotton'>
            <h1>About Us</h1>
            <p>Welcome to Ruspina Professional Training Center!
